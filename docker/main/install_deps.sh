...
if [[ "${TARGETARCH}" == "amd64" ]]; then
    ...
    gpg --no-default-keyring --keyring=./temp.gpg --keyserver hkps://keyserver.ubuntu.com --recv-keys 4096R/0C0E6AF955CE463C03FC51574D098D70AFBE5E1F | gpg --yes --dearmor --output /usr/share/keyrings/intel-graphics.gpg ./temp.gpg
